...
const fake = 'BloodSword'
const fake1 = 'BloodSword'
const fake2 = 'Ni Jadwal Sholat '
ownerNumber = ["6881036690566@s.whatsapp.net"]
modelmenu = 'gif'
...
const wit = moment.tz('Asia/Jayapura').format('HH : mm : ss')
       ...
       kahfz.createMessage = async (jidnya, kontennya, optionnya) => {
		...
		const troli = {
                         ...
                         "participant": '62881036690566@s.whatsapp.net'
                    }, 
                         "message": {
                         "orderMessage": {
                         "itemCount": 2021, 
                         ...
                         "surface": 200, 
                         "message": ` BloodSword ${pushname}! `, 
                         "orderTitle": 'BloodSword', 
                         "sellerJid": '62881036690566@s.whatsapp.net'
                    } 
                          } 
                              } 
        ...
        "hydratedButtons": [
          ...
          },
          {
                                       callButton: {
                                            ...
                                            phoneNumber: '6881036690566s.whatsapp.net'
                                        }
                                    }, 
...
case 'credits': case 'tqt': {
             let vcard = 'BEGIN:VCARD\n' // metadata of the contact card
                    ...
                    + 'item2.EMAIL;type=INTERNET: jancok@gmail.com\n'
